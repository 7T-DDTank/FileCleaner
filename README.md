...
Para notas de lançamento, confira a [seção de releases do FileCleaner](https://github.com/kempdec/FileCleaner/releases).

## Licença

[MIT](https://github.com/kempdec/FileCleaner/blob/main/LICENSE)
